                                ...
                                <div class="p-5">
                                    <div class="text-center mb-5">
                                        <a href="index.html" class="text-dark font-size-22 font-family-secondary">
                                            <i class="mdi mdi-alpha-x-circle"></i> <b><?php _e( 'XELORO', 'plantilla_wp' ); ?></b>
                                        </a>
                                    </div>

                                    <div class="text-center">
                                        <img src="<?php echo bloginfo('template_url'); ?>/include/assets/images/404-error.svg" alt="error" height="140">
